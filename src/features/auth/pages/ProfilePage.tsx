...
import { User as UserIcon, Mail, Phone, Lock, Save, Loader2 } from 'lucide-react'
...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      <div className="bg-white dark:bg-stone-900 rounded-3xl border border-stone-100 dark:border-stone-800 p-6 md:p-8 shadow-xl dark:shadow-stone-950/60 transition-all">
